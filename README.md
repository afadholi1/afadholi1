...
## 🚀 Tentang Saya
- 💻 Saat ini saya sedang mendalami ekosistem **React.js**.
- 🌱 Saya selalu antusias mempelajari teknologi *frontend* terbaru.
- 👯 Saya terbuka untuk kolaborasi dalam proyek *open-source* atau freelance.
- 💬 Tanya saya tentang: **HTML, CSS, JS, atau React**.

---

## 🛠️ Tech Stack
Berikut adalah teknologi yang biasa saya gunakan untuk membangun proyek:
